...
def save_qualifying_loans(qualifying_loans):
    ...
    - If there are no qualifying loans, notify user and exit
    - If there is a list of qualifying loans, prompt user using a menu if user wants to save the qualifying loans to a csv file
    - If user selects No, the app exits
    - If user selects Yes, prompt user to enter a path and filename, and save the qualifying loans in the file
...
def run():
    ...
    #Print qualifying loans
    #print("These are the qualifying loans: ", *qualifying_loans, sep = "\n")
